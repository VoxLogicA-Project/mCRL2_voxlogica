...
#include <memory>
#include "../../../../../../tools/release/diagraphica/shape.h"
...
QT_MOC_LITERAL(1, 6, 14), // "setModeEditDof"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 8) // "dofIndex"
...
void Shape::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->setModeEditDof((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}
